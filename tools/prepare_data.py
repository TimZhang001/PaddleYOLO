...
if __name__ == "__main__":
    ...
    project_path  = r"D:\Dataset\AI质检2024\裁剪图片\dataset_crop_good" #Mura_Project_Large Mura_Project_Small Mura_Project_AD Common Lines
    project_types = ["Alls"] # "Alls" Common  Lines
