...
job_name=ppyolo_mbv3_small_coco # 可修改，如 yolov7_tiny_300e_coco
project_name=Mura
...
CUDA_VISIBLE_DEVICES=6 python tools/train.py -c ${config} --eval --amp --vdl_log_dir vdl_log_dir/${job_name}
