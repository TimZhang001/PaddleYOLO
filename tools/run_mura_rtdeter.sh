...
job_name=rtdetr_r34vd_6x_coco # 可修改，如 yolov7_tiny_300e_coco
project_name=Mura
...
CUDA_VISIBLE_DEVICES=5 python tools/train.py -c ${config} --eval --amp --use_vdl --vdl_log_dir vdl_log_dir/${job_name}
